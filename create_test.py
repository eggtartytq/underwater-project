...
target_file = 'test_val\images'
current_file=os.path.dirname(os.path.abspath(__file__))
train_file= os.path.join(current_file, target_file)

Gaussian_Noise = os.path.join(current_file, 'test_val\modified\Gaussian_Noise')
Shot_Noise = os.path.join(current_file, 'test_val\modified\Shot_Noise')
Impulse_Noise = os.path.join(current_file, 'test_val\modified\Impulse_Noise')
Defocus_Blur = os.path.join(current_file, 'test_val\modified\Defocus_Blur')
Frosted_Glass_Blur = os.path.join(current_file, 'test_val\modified\Frosted_Glass_Blur')
Motion_Blur = os.path.join(current_file, 'test_val\modified\Motion_Blur')
Zoom_Blur = os.path.join(current_file, 'test_val\modified\Zoom_Blur')
Brightness = os.path.join(current_file, 'test_val\modified\Brightness')
Contrast = os.path.join(current_file, 'test_val\modified\Contrast')
Elastic = os.path.join(current_file, 'test_val\modified\Elastic')
Pixelate = os.path.join(current_file, 'test_val\modified\Pixelate')
jpeg_comp = os.path.join(current_file, 'test_val\modified\jpeg_comp')
